...
namespace flash {
    ...
    __global__ void __launch_bounds__(Ktraits::kNWarps* cutlass::NumThreadsPerWarp,
        ...
        compute_attn_ws(
            ...
            Ktraits, Is_causal, Is_local, /*Is_2d=*/true, Seqlen_traits,
        ...
        using CollectiveMainloop =
            CollectiveMainloopFwd<Ktraits, Is_causal, Is_local, /*Is_2d=*/true,
        ...
        CUTE_LOG_DEBUG("debug %d\n", 1);
        CUTE_LOG_DEBUG("debug %d\n", 2);
        if (block0() && thread0()) {
            CUTE_LOG_DEBUG("warp_idx: %d\n", warp_idx);
        }
