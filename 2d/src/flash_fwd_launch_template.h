 ...
 ******************************************************************************/
#ifndef FLASHATTENTION_ENABLE_2D
#error "FLASHATTENTION_ENABLE_2D is not defined!"
#endif
static_assert(true, "FLASHATTENTION_ENABLE_2D is defined");
...
void run_flash_fwd(Flash_fwd_params& params, cudaStream_t stream) {
  ...
  using CollectiveMainloop = flash::CollectiveMainloopFwd<Kernel_traits, Is_causal, Is_local, /*Is_2d=*/true, Seqlen_traits, Seqlen_traits_Q>;
  ...
  typename CollectiveMainloop::Params mainloop_params =
    CollectiveMainloop::to_underlying_arguments({
        ...
        ,
        {params.height, params.width, params.window_size_top, params.window_size_bottom}
        #endif
                                                });
